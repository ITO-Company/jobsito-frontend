...
interface RequestListCompanyProps {
  issueId: string
}

export function RequestListCompany({ issueId }: RequestListCompanyProps) {
            ...
            <Card key={request.id}>
              <CardContent className="pt-6">
                <div className="flex justify-between items-start gap-4">
                  ...
                  <Button
                    onClick={() => navigate(`/company/internships/requests/${request.id}`)}
                    variant="default"
                    size="sm"
                  >
                    Ver
