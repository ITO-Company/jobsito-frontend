...
export function AssignTags() {
  ...
  const handleAddTag = async (tagId: string) => {
    try {
      ...
      setProficiency({ ...proficiency, [tagId]: '' })
    } catch (error) {
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-4xl mx-auto">
        <Card className="mb-6">
          <CardHeader>
            <CardTitle>Asignar Habilidades</CardTitle>
            <CardDescription>Agrega tus habilidades y define tu nivel de proficiencia</CardDescription>
          </CardHeader>
        </Card>
